                ...
                @role('superadmin')
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            {!! trans('titles.superadminDropdownNav') !!}
                        </a>
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item {{ Request::is('addresses', 'addresses/' . Auth::user()->id, 'addresses/' . Auth::user()->id . '/edit') ? 'active' : null }}" href="{{ url('/addresses') }}">
                                {!! trans('titles.adminAddressList') !!}
                            </a>
                            {{--<div class="dropdown-divider"></div>--}}
                            {{--<a class="dropdown-item {{ Request::is('addresses/create') ? 'active' : null }}" href="{{ url('/addresses/create') }}">--}}
                                {{--{!! trans('titles.adminNewAddress') !!}--}}
                            {{--</a>--}}
                            <div class="dropdown-divider"></div>
